...
try:
    ...
    config = {"dataBaseFile": "raptorchain-testnet-3.json", "nodePrivKey": "20735cc14fd4a86a2516d12d880b3fa27f183a381c5c167f6ff009554c1edc69", "peers":["https://rptr-testnet-1.dynamic-dns.net/"], "InitTxID": "RPTRTESTNET", "netLogFile": "rptrnetlog.log"}
...
class BeaconChain(object):
    def __init__(self):
        ...
        self.bsc = BSCInterface("https://data-seed-prebsc-1-s1.binance.org:8545/", "0x0c65559063fda785E55ceEd23CB55b2828835020", "0xC64518Fb9D74fabA4A748EA1Db1BdDA71271Dc21")
